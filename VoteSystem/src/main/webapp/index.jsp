            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom">
                        ...
                        <a class="text-center center-block" href="${pageContext.request.contextPath}/register.jsp">去注册</a>
                        <a class="text-center center-block" href="${pageContext.request.contextPath}/login_admin.jsp">去后台</a>
                    </div>
                </div>
            </div>
